...
from features.clean import clean_bike_rtes, clean_bus_lanes, clean_ped_plaza, clean_traffic_calming
...
if __name__ == '__main__':
    ...
    parser.add_argument('location', type=str, help="Specify location. e.g.: 'Downtown Brooklyn, New York, USA'")
